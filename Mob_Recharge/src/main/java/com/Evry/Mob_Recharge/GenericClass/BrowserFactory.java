package com.Evry.Mob_Recharge.GenericClass;
 ...
 * @param <HtmlUnitDriver>
 */
public class BrowserFactory<HtmlUnitDriver> {
	Map<String,String> browserSpec;
	WebDriver webDriver;
	static Logger logger;
	String ie_driver_path = "D:/software/Selenium/IEDriverServer.exe";
	int ie_driver_port;
	...
	public BrowserFactory(String browser_type) {
        ...
        try {
            //load a properties file
           	prop.load(BrowserFactory.class.getClassLoader().getResourceAsStream("BrowserProperties"));
